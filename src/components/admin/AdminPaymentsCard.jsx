    ...
    <Card className="p-4" style={{ borderColor: `${C.orange}44` }}>
      ...
      <div className="mt-3 space-y-2.5">
        <label className="block">
          <div className="flex items-center justify-between">
            <span style={{ color: "#9a9a9a", fontSize: 11, fontWeight: 700 }}>Chave Pix Direta da Pizzaria</span>
            <span style={{ color: C.yellowLight, fontSize: 10 }}>Padrão Banco Central</span>
          </div>
          <input
            value={pixKey}
            onChange={(e) => setPixKey(e.target.value)}
            placeholder="ex.: 81999990000 ou chave-pix-da-loja ou CNPJ"
        ...
        <label className="block">
          ...
          <input
            ...
            placeholder="ex.: https://pedidos.sua-pizzaria.com.br"
            className="w-full rounded-lg px-2.5 py-2 mt-1 outline-none"
            style={inField}
          />
          <span style={{ color: "#6a6a6a", fontSize: 10 }}>
