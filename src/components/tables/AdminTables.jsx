  ...
  const printTableBill = (t) => {
    ...
    printHTML(`
      <div style="font-family:sans-serif; padding:12px; max-width:280px; margin:0 auto; font-size:12px;">
        <h2 style="text-align:center; margin:0 0 4px;">MIL GRAU PIZZARIA</h2>
        ...
        tables.map(async (t) => {
          ...
          return `
            <div style="border: 2px dashed #000; border-radius: 14px; padding: 18px 14px; text-align: center; background: #fff; width: 44%; margin: 2% 2%; box-sizing: border-box; page-break-inside: avoid; display: inline-block; vertical-align: top;">
              <div style="font-size: 16px; font-weight: 900; color: #f58200; margin-bottom: 2px;">🍕 MIL GRAU PIZZARIA</div>
              <div style="font-size: 10px; font-weight: 700; text-transform: uppercase; color: #666; margin-bottom: 8px;">Pizzas Artesanais</div>
      ...
      printHTML(`
        <div style="font-family: sans-serif; padding: 10px; text-align: center;">
          <div style="margin-bottom: 14px; font-size: 12px; color: #555;">
            <strong>Plaquinhas de Mesa Mil Grau!</strong> — Imprima em folha A4, recorte nas linhas pontilhadas e coloque nos displays acrílicos.
          </div>
          ${cards.join("")}
        </div>
      `);
