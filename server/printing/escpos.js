// ============================================================
// MIL GRAU PIZZARIA — Impressão direta em impressora térmica (ESC/POS)
//
...
export function buildKitchenComanda(order, storeName = "MIL GRAU PIZZARIA") {
  const b = new EscposBuilder();
  center(b, storeName || "MIL GRAU PIZZARIA", { double: true, bold: true });
...
export function buildExpeditionComanda(order, storeName = "MIL GRAU PIZZARIA") {
  const b = new EscposBuilder();
  center(b, storeName || "MIL GRAU PIZZARIA", { double: true, bold: true });
...
export function buildLabel(order) {
  const b = new EscposBuilder();
  center(b, `PEDIDO #${order.code}`, { double: true, bold: true }).divider();
...
export function buildTestPage(storeName = "MIL GRAU PIZZARIA") {
  const b = new EscposBuilder();
