// ============================================================
// Pizzaria — Camada de banco (SQLite via node:sqlite)
// O arquivo vive em server/data/pizzeria.db (fora do git).
// ============================================================
...
const DB_FILE = path.join(DATA_DIR, "pizzeria.db");
...
// Dados do catálogo são semeados a partir de server/data.js.
